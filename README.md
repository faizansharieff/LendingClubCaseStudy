...
- Step 1 - Dropping Columns based on EDA and Domain Knowledge
- Step 2 - Convert the data types
- Step 3 - Identify columns with blank values which need to be imputed
- Step 4 - Analysis of the dataset post cleanup
- Step 5 - **Analysis** - Univariate, Bivariate and Derived Metrics Analysis
- Step 6 - **Conclusions** Inferences and Recommendations
